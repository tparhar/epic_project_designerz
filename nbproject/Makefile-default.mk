...
FINAL_IMAGE=${DISTDIR}/epic_project_designerz.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/epic_project_designerz.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${DISTDIR}/epic_project_designerz.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}\\avr-objcopy -O ihex "${DISTDIR}/epic_project_designerz.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}" "${DISTDIR}/epic_project_designerz.X.${IMAGE_TYPE}.hex"
endif
